...
def initialize_model(
    ...
    with torch.no_grad():
        ...
        if model_type == "universal":
            ...
            for l in model.src_embed.keys():
                model.src_embed[l].lut.weight.data[src_padding_idx].zero_()
            for l in model.trg_embed.keys():
                model.trg_embed[l].lut.weight.data[trg_padding_idx].zero_()
